# 这是没有改动过的 github 上 d-center-main 的代码，用于保存原始代码
# 仅仅修改了本地模型的路径，其他没有修改。
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('./ObjectDet/cent_resnet18.pth', map_location=device, weights_only=True))
    model.eval()

    data_path     = './ObjectDet/'
    save_path     = './ObjectDet/' # 写成相对主目录的路径
